...
<head>
	...
	<title>Recapitulatif Tickets</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Recapitulatif Tickets</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Recapitulatif Tickets</div>
...
{				?>	
        ...
        data="test.xlsx" width="300" height="200">Telecharger recapitulatif excel <a href="test.xlsx">diagramme.xls</a>
