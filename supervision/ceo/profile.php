...
if(isset($_POST['submit']))
  {	
	...
	$sql="UPDATE utilisateur SET login=(:login), email=(:email)";
	$query = $dbh->prepare($sql);
	$query-> bindParam(':login', $login, PDO::PARAM_STR);
	$query-> bindParam(':email', $email, PDO::PARAM_STR);
	$query->execute();
	$msg="Informations mise a jour avec succes";
}    
?>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Modification Info</div>
