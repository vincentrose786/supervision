			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Dashboard CEO</h2>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Client</div>
												</div>
											</div>
...
$sql1 ="SELECT idticket from ticket";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Recapitulatif Tickets incident</div>
												</div>
											</div>
