...
<head>
	...
	<title>Edition d'un ticket incident</title>
...
<body>
<?php
		$sql = "SELECT * from utilisateur where id = :editid";
		$query = $dbh -> prepare($sql);
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Modification ticket : <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">modif Info ticket</div>
