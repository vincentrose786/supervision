...
$sql ="SELECT idequipement from equipement";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
													...
													<div class="stat-panel-title text-uppercase">Liste des composants</div>
												</div>
											</div>
											<a href="composant.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Gestion de tickets</div>
												</div>
											</div>
											<a href="ticket.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
